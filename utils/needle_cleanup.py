...
This script provides the ability to remove unused/unwanted needles
from a branch of the needles repository.
"""
...
def delete_needles_and_submit_mr(
    ...
    needles_to_delete = []
    for needle in needles_list:
        needles_to_delete.append(needle + ".png")
        needles_to_delete.append(needle + ".json")
    ...
    print(
        f"Created branch: {branch_name},  with a commit for the deletion of the needles"
    )
...
def commandline_interface(
    ...
    """Commandline menu interface for deletion of needles and generating MR."""
    while True:
        print("\nWhat would you like to do?")
        if unused_needles:
            print("[u] Delete unused needles and submit MR")
        if expiry_date and expired_needles:
            print("[e] Delete expired needles and submit MR")
        print("[q] Quit")
        command = input(":")
